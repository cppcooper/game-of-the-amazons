...
public class Heuristics {
	...
	// todo (refactor heuristics): implement with data from territory heuristic
	// todo (refactor heuristics): provide two variants, one for reduction and one for mobility - then use reduction for pruning moves
	...
	// todo (refactor heuristics): revise to calculate winner
